...
local function ShowPinMenu(pin, button)
	...
	AddMenuItem(
		"Delete",
		function()
			HarvensThievesTrovesMarker:DeletePin(pTag)
		end
	)
...
function HarvensThievesTrovesMarker:SetupMapFilter()
	...
	WORLD_MAP_FILTERS.pvePanel:AddPinFilterCheckBox(
		9334,
		function(...)
...
function HarvensThievesTrovesMarker:Initialize(eventType, addonName)
	...
	EVENT_MANAGER:UnregisterForEvent("HarvensThievesTrovesMarker", EVENT_ADD_ON_LOADED)
...
EVENT_MANAGER:RegisterForEvent(
	"HarvensThievesTrovesMarker",
	EVENT_ADD_ON_LOADED,
	function(...)
		HarvensThievesTrovesMarker:Initialize(...)
	end
)