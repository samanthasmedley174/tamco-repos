...
function LootWall:InitializeHandlers()
	...
	EVENT_MANAGER:RegisterForEvent(
		...
		function(_, ...)
			self:StoreOpened(...)
			self:StartLootIgnore(LW_CONF_IGNORE_SHOP)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		EVENT_OPEN_BANK,
		function(_, ...)
			self:StartLootIgnore(LW_CONF_IGNORE_BANK)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		EVENT_CLOSE_BANK,
		function(_, ...)
			self:EndLootIgnore(LW_CONF_IGNORE_BANK)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		EVENT_OPEN_FENCE,
		function(_, ...)
			self:StartLootIgnore(LW_CONF_IGNORE_FENCE)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		EVENT_CLOSE_FENCE,
		function(_, ...)
			self:EndLootIgnore(LW_CONF_IGNORE_FENCE)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		...
		function(_, ...)
			self:StartLootIgnore(LW_CONF_IGNORE_GUILDBANK)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		...
		function(_, ...)
			self:EndLootIgnore(LW_CONF_IGNORE_GUILDBANK)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		...
		function(_, ...)
			self:StartLootIgnore(LW_CONF_IGNORE_MAIL)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		...
		function(_, ...)
			self:EndLootIgnore(LW_CONF_IGNORE_MAIL)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		EVENT_CLOSE_STORE,
		function(_, ...)
			self:EndLootIgnore(LW_CONF_IGNORE_SHOP)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		...
		function(_, _, _, ...)
			self:StartLootIgnore(LW_CONF_IGNORE_CRAFT)
		end
	)
	EVENT_MANAGER:RegisterForEvent(
		self.name,
		...
		function(_, ...)
			self:EndLootIgnore(LW_CONF_IGNORE_CRAFT)
		end
	)
	--[[
...
function LootWall:Initialize()
	...
	local optionsControls = {
		...
		},
		{
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_QUALITY_THRESHOLD)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_QUALITY_THRESHOLD, value)
			end
		},
		{
			type = "dropdown",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPORNATE)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPORNATE, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPINSP)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPINSP, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPNIRN)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPNIRN, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPTRASH)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPTRASH, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPBAIT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPBAIT, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPLOCKPICK)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPLOCKPICK, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_SELLJUNK)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_SELLJUNK, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_SHOWCURSOR)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_SHOWCURSOR, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_SHOWHINT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_SHOWHINT, value)
			end
		},
		{
			type = "header",
		...
		},
		{
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPSTYLEMATS)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPSTYLEMATS, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPALCHMAT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPALCHMAT, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPENCHMAT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPENCHMAT, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPPROVMAT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPPROVMAT, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPCLOTHMAT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPCLOTHMAT, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPBSMAT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPBSMAT, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPWWMAT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPWWMAT, value)
			end
		},
		{
			type = "header",
		...
		},
		{
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPRES_BS)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPRES_BS, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPRES_CLOTH)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPRES_CLOTH, value)
			end
		},
		{
			type = "dropdown",
			...
			choices = {LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_PROMPT], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_DESTROY], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_JUNK], LW_PRESET_ACTION_STRING[LW_PRESET_ACTION_KEEP]},
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_KEEPRES_WW)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_KEEPRES_WW, value)
			end
		},
		{
			type = "header",
		...
		},
		{
			...
			disabled = true,
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_IGNORE_BANK)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_IGNORE_BANK, value)
			end
		},
		{
			type = "checkbox",
			...
			disabled = true,
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_IGNORE_GUILDBANK)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_IGNORE_GUILDBANK, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_IGNORE_SHOP)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_IGNORE_SHOP, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_IGNORE_MAIL)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_IGNORE_MAIL, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_IGNORE_CRAFT)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_IGNORE_CRAFT, value)
			end
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return self:GetConfValueForKey(LW_CONF_IGNORE_FENCE)
			end,
			setFunc = function(value)
				self:SetConfValueForKey(LW_CONF_IGNORE_FENCE, value)
			end
		},
		{
			type = "header",
...
function LootWall:MakeItemStringId(itemLink)
	...
	itemValue = GetItemLinkValue(itemLink) > 1 and 1 or 0
...
function LootWall:DefaultActionForLink(itemLink)
	...
	for conf, types in pairs(LW_ITEMTYPE_ACTION) do
		if (configs[conf] > LW_PRESET_ACTION_PROMPT) then
			if self:IsItemOfType(itemLink, types) then
				return self:PresetToAction(configs[conf])
			end
		end
	end

	if (self.savedVariables.conf[LW_CONF_KEEPORNATE] > LW_PRESET_ACTION_PROMPT) then
		if GetItemLinkValue(itemLink) > 1 and (itemTrait == ITEM_TRAIT_TYPE_ARMOR_ORNATE or itemTrait == ITEM_TRAIT_TYPE_WEAPON_ORNATE or itemTrait == ITEM_TRAIT_TYPE_JEWELRY_ORNATE) then
	...
	if
		self:IsInRange(
			key,
			{
				LW_CONF_KEEPALCHMAT,
				LW_CONF_KEEPBSMAT,
				LW_CONF_KEEPCLOTHMAT,
				LW_CONF_KEEPENCHMAT,
				LW_CONF_KEEPINSP,
				LW_CONF_KEEPNIRN,
				LW_CONF_KEEPORNATE,
				LW_CONF_KEEPSTYLEMATS,
				LW_CONF_KEEPWWMAT,
				LW_CONF_KEEPPROVMAT,
				LW_CONF_KEEPBAIT,
				LW_CONF_KEEPTRASH,
				LW_CONF_KEEPRES_BS,
				LW_CONF_KEEPRES_CLOTH,
				LW_CONF_KEEPRES_WW,
				LW_CONF_KEEPLOCKPICK
			}
		)
	 then
...
function LootWall:ItemHasRule(itemLink, itemIdentifier)
	...
	if itemIdentifier == nil then
		itemIdentifier = self:MakeItemStringId(itemLink)
	end
...
local function df(format, ...)
	CHAT_ROUTER:AddSystemMessage(string.format(format, ...))
end
...
local function PreHookSetItemIsJunk()
	...
	function LootWall:ApplyRuleToItem(rule, itemBagId, itemSlotId, itemLink)
		...
		elseif (rule == LW_ACTION_TRASH_SECOND) then
			...
			if result[1].size < result[1].max then
				return
			end
...
do
	...
	local function AddMenuItem(inventorySlot, slotActions)
		slotActions:AddCustomSlotAction(
			SI_BINDING_NAME_LOOTWALL_APPLY_RULE,
			function()
				local bagId, slotIndex = ZO_Inventory_GetBagAndIndex(inventorySlot)
