...
local function CreateSettings()
	...
	settings:AddSetting {
		...
		getFunction = function()
			return UnitFrames.account.showUnitShield
		end,
		setFunction = function(bool)
	...
	settings:AddSetting {
		...
		getFunction = function()
			return UnitFrames.account.enablePetHealth
		end,
		setFunction = function(bool)
	...
	settings:AddSetting {
		...
		getFunction = function()
			return UnitFrames.account.enableApproachAmountOnPlayerHealthBar
		end,
		setFunction = function(bool)
			UnitFrames.account.enableApproachAmountOnPlayerHealthBar = bool
		end
	}
end
